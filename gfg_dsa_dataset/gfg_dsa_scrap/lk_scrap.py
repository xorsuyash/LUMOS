...
class DsaLkScraper(GfgDsaScrap):
    def land_gfg_dsa_lk_page(self):
        self.get(const.gfg_dsa_linked_list_page_url)
        link_elements = self.find_elements(By.CSS_SELECTOR, ".entry-content a")
        links = [link.get_attribute("href") for link in link_elements]
        os.mkdir("gfg_dsa/linked_list")
        for link in links:
            ...
            try:
                ...
                with open(f"gfg_dsa/linked_list/gfg_dsa_linked_list_{title}.txt", "w") as f:
